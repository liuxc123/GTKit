...
/**
 A cut corner treatment subclassing GTCCornerTreatment.
 This can be used to set corners in GTCRectangleShapeGenerator.
 */
@interface GTCCutCornerTreatment : GTCCornerTreatment
...
/**
 ...
 with GTCCutCornerTreatment and a cut value of 50 then the final result will be a diamond with a
 size of 50x50.
 +--------------+                     /\
 |              |                   /    \ 50
 |              |                 /        \
...
/**
 Initializes an GTCCutCornerTreatment instance with a given cut.
 */
- (nonnull instancetype)initWithCut:(CGFloat)cut NS_DESIGNATED_INITIALIZER;

/**
 Initializes an GTCCutCornerTreatment instance with a cut of zero.
 */
