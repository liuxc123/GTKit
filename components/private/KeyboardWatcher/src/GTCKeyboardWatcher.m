...
NSString *const GTCKeyboardWatcherKeyboardWillShowNotification =
@"GTCKeyboardWatcherKeyboardWillShowNotification";
NSString *const GTCKeyboardWatcherKeyboardWillHideNotification =
@"GTCKeyboardWatcherKeyboardWillHideNotification";
NSString *const GTCKeyboardWatcherKeyboardWillChangeFrameNotification =
@"GTCKeyboardWatcherKeyboardWillChangeFrameNotification";

static GTCKeyboardWatcher *_sKeyboardWatcher;

@interface GTCKeyboardWatcher ()
...
@implementation GTCKeyboardWatcher
...
+ (void)load {
    @autoreleasepool {
        _sKeyboardWatcher = [[GTCKeyboardWatcher alloc] init];
    }
}
...
+ (NSTimeInterval)animationDurationFromKeyboardNotification:(NSNotification *)notification {
    if (![notification.name isEqualToString:GTCKeyboardWatcherKeyboardWillShowNotification] &&
        ![notification.name isEqualToString:GTCKeyboardWatcherKeyboardWillHideNotification] &&
        ![notification.name isEqualToString:GTCKeyboardWatcherKeyboardWillChangeFrameNotification]) {
...
- (void)keyboardWillShow:(NSNotification *)notification {
    ...
    [[NSNotificationCenter defaultCenter]
     postNotificationName:GTCKeyboardWatcherKeyboardWillShowNotification
     object:self
...
- (void)keyboardWillChangeFrame:(NSNotification *)notification {
    [self updateKeyboardOffsetWithKeyboardUserInfo:notification.userInfo];
    [[NSNotificationCenter defaultCenter]
     postNotificationName:GTCKeyboardWatcherKeyboardWillChangeFrameNotification
     object:self
     userInfo:notification.userInfo];
}
...
- (void)keyboardWillHide:(NSNotification *)notification {
    ...
    self.keyboardFrame = CGRectZero;
    [[NSNotificationCenter defaultCenter]
     postNotificationName:GTCKeyboardWatcherKeyboardWillHideNotification
     object:self
     userInfo:notification.userInfo];
}
