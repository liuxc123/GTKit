...
@implementation GTCNumericValueLabel{
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _label.font = [GTCTypography body1Font];  // Default font size, override by setting fontSize
...
- (void)setFontSize:(CGFloat)fontSize {
    _label.font = [[GTCTypography fontLoader] regularFontOfSize:fontSize];
}
