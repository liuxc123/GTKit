...
@class GTCThumbView;
@protocol GTCThumbTrackDelegate;

@interface GTCThumbTrack : UIControl

/** The delegate for the thumb track. */
@property(nullable, nonatomic, weak) id<GTCThumbTrackDelegate> delegate;
...
@property(nonatomic, assign) GTCShadowElevation thumbElevation;
...
@property(nullable, nonatomic, strong) GTCThumbView *thumbView;
...
/** GTCThumbtrack delegate which allows setting custom behavior. */
@protocol GTCThumbTrackDelegate <NSObject>
@optional
 ...
 */
- (nonnull NSString *)thumbTrack:(nonnull GTCThumbTrack *)thumbTrack stringForValue:(CGFloat)value;

/**
 Called when the user taps on the GTCThumbTrack.
 If not implemented, the GTCThumbTrack will always be allowed to jump to any value.
 */
- (BOOL)thumbTrack:(nonnull GTCThumbTrack *)thumbTrack shouldJumpToValue:(CGFloat)value;

/**
 Called when the thumb track will jump to a specific value.

 @param thumbTrack The @c GTCThumbTrack sender.
 @param value The new value for the slider.
 */
- (void)thumbTrack:(nonnull GTCThumbTrack *)thumbTrack willJumpToValue:(CGFloat)value;
...
/**
 ...
 @param value The new value for the slider.
 */
- (void)thumbTrack:(nonnull GTCThumbTrack *)thumbTrack willAnimateToValue:(CGFloat)value;
...
/**
 ...
 @param value The new value for the slider.
 */
- (void)thumbTrack:(nonnull GTCThumbTrack *)thumbTrack didAnimateToValue:(CGFloat)value;
