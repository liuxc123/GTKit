...
static NSString *const kBundleName = @"GTIcons_ic_arrow_back";
...
__attribute__((visibility("default")))
    char GTCIconsExportToSuppressLibToolWarning_ic_arrow_back = 0;

@implementation GTCIcons (ic_arrow_back)
