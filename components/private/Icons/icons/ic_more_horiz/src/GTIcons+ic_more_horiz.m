...
static NSString *const kBundleName = @"GTIcons_ic_more_horiz";
...
__attribute__((visibility("default")))
    char GTCIconsExportToSuppressLibToolWarning_ic_more_horiz = 0;

@implementation GTCIcons (ic_more_horiz)
