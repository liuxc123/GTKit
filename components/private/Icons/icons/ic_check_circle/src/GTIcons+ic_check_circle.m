...
static NSString *const kBundleName = @"GTIcons_ic_check_circle";
...
__attribute__((visibility("default")))
    char GTCIconsExportToSuppressLibToolWarning_ic_check_circle = 0;

@implementation GTCIcons (ic_check_circle)
