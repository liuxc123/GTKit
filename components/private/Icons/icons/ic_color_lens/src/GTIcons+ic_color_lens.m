...
static NSString *const kBundleName = @"GTIcons_ic_color_lens";
...
__attribute__((visibility("default")))
    char GTCIconsExportToSuppressLibToolWarning_ic_color_lens = 0;

@implementation GTCIcons (ic_color_lens)
