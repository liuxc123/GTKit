...
static NSString *const kBundleName = @"GTIcons_ic_help_outline";
...
__attribute__((visibility("default")))
    char GTCIconsExportToSuppressLibToolWarning_ic_help_outline = 0;

@implementation GTCIcons (ic_help_outline)
