...
static NSString *const kBundleName = @"GTIcons_ic_chevron_right";
...
__attribute__((visibility("default")))
    char GTCIconsExportToSuppressLibToolWarning_ic_chevron_right = 0;

@implementation GTCIcons (ic_chevron_right)
