...
static NSString *const kBundleName = @"GTIcons_ic_radio_button_unchecked";
...
__attribute__((visibility("default")))
    char GTCIconsExportToSuppressLibToolWarning_ic_radio_button_unchecked = 0;

@implementation GTCIcons (ic_radio_button_unchecked)
