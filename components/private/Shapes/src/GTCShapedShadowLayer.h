 ...
 */
@interface GTCShapedShadowLayer : GTCShadowLayer
...
/*
 The GTCShapeGenerating object used to set the shape's path and shadow path.

 The path will be set upon assignment of this property and whenever layoutSublayers is called.
 */
@property(nonatomic, strong, nullable) id<GTCShapeGenerating> shapeGenerator;
