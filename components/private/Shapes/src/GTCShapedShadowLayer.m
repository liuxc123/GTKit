...
@implementation GTCShapedShadowLayer

- (instancetype)init {
    self = [super init];
    if (self) {
        [self commonGTCShapedShadowLayerInit];
    }
    return self;
}
...
- (instancetype)initWithLayer:(id)layer {
    ...
    if (self && [self isKindOfClass:[GTCShapedShadowLayer class]]) {
        GTCShapedShadowLayer *otherLayer = (GTCShapedShadowLayer *)layer;
...
- (void)commonGTCShapedShadowLayerInit {
...
- (void)layoutSublayers {
    ...
    // to be correctly set before GTCShadowLayer performs layoutSublayers.
