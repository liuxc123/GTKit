...
/**
 GTCPathGenerator is a factory for creating CGPaths. Describe your path with the
 lineTo and addArc... methods, then call appendToCGPath to append them to a
 CGPath.

 @note GTCPathGenerators always start at (0, 0) and end at @c endPoint.
 */
@interface GTCPathGenerator : NSObject
...
/**
 Returns an initialized GTCPathGenerator instance with a startPoint of CGPointZero.
 */
+ (nonnull instancetype)pathGenerator;

/**
 Returns an initialized GTCPathGenerator instance.
