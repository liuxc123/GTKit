 ...
 */
+ (UIImage * _Nullable)gtc_animatedImageWithAnimatedGIFData:(NSData * _Nonnull)theData;
 ...
 */
+ (UIImage * _Nullable)gtc_animatedImageWithAnimatedGIFURL:(NSURL * _Nonnull)theURL;
