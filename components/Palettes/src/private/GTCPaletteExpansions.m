//
//  GTCPaletteExpansions.m
//  GTCatalog
//
//  Created by liuxc on 2018/8/24.
//

#import "GTCPaletteExpansions.h"
...
static int NameToIndex(NSString *_Nonnull name) {
    ...
    dispatch_once(&onceToken, ^{
        map = @{
                GTC_PALETTE_TINT_50_INTERNAL_NAME : @(kQTMColorTint50Index),
                GTC_PALETTE_TINT_100_INTERNAL_NAME : @(kQTMColorTint100Index),
                GTC_PALETTE_TINT_200_INTERNAL_NAME : @(kQTMColorTint200Index),
                GTC_PALETTE_TINT_300_INTERNAL_NAME : @(kQTMColorTint300Index),
                GTC_PALETTE_TINT_400_INTERNAL_NAME : @(kQTMColorTint400Index),
                GTC_PALETTE_TINT_500_INTERNAL_NAME : @(kQTMColorTint500Index),
                GTC_PALETTE_TINT_600_INTERNAL_NAME : @(kQTMColorTint600Index),
                GTC_PALETTE_TINT_700_INTERNAL_NAME : @(kQTMColorTint700Index),
                GTC_PALETTE_TINT_800_INTERNAL_NAME : @(kQTMColorTint800Index),
                GTC_PALETTE_TINT_900_INTERNAL_NAME : @(kQTMColorTint900Index),
                GTC_PALETTE_ACCENT_100_INTERNAL_NAME : @(kQTMColorAccent100Index),
                GTC_PALETTE_ACCENT_200_INTERNAL_NAME : @(kQTMColorAccent200Index),
                GTC_PALETTE_ACCENT_400_INTERNAL_NAME : @(kQTMColorAccent400Index),
                GTC_PALETTE_ACCENT_700_INTERNAL_NAME : @(kQTMColorAccent700Index)
                };
    });
...
UIColor *GTCPaletteTintFromTargetColor(UIColor *targetColor, NSString *tintName) {
    NSCAssert(GTCPaletteIsTintOrAccentName(tintName), @"Invalid tint/accent name %@.", tintName);
...
UIColor *GTCPaletteAccentFromTargetColor(UIColor *targetColor, NSString *accentName) {
    NSCAssert(GTCPaletteIsTintOrAccentName(accentName), @"Invalid tint/accent name %@.", accentName);
