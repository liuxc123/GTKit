...
/**
 GTCTypography uses this protocol to delegate responsibility of loading the custom fonts.
 ...
 @warning This protocol will soon be deprecated. Consider using GTCTypographyScheme from the
 schemes/Typography component instead.

 @see https://material.io/go/design-typography#typography-styles
 */
@protocol GTCTypographyFontLoading <NSObject>
@required
...
/**
 ...
 @warning This class will soon be deprecated. Consider using GTCTypographyScheme from the
 schemes/Typography component instead.

 @see https://material.io/go/design-typography#typography-styles
 */
@interface GTCTypography : NSObject

#pragma mark - Font loader access

/** Set the font loader in order to use a non-system font. */
+ (void)setFontLoader:(nonnull id<GTCTypographyFontLoading>)fontLoader;

/** Get the current font loader. */
+ (nonnull id<GTCTypographyFontLoading>)fontLoader;
...
/**
 GTCSystemFontLoader allows you to use the system font for @c GTCTypography.
 ...
 ```
 [GTCTypography setFontLoader:[[GTCSystemFontLoader alloc] init]];
 ```
 */
@interface GTCSystemFontLoader : NSObject <GTCTypographyFontLoading>
@end
