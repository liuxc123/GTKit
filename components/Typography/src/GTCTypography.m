...
#import "private/UIFont+GTCTypographyPrivate.h"

static id<GTCTypographyFontLoading> gFontLoader = nil;
const CGFloat GTCTypographyStandardOpacity = 0.87f;
const CGFloat GTCTypographySecondaryOpacity = 0.54f;

@implementation GTCTypography

#pragma mark - Font loader access

+ (void)setFontLoader:(id<GTCTypographyFontLoading>)fontLoader {
...
+ (id<GTCTypographyFontLoading>)fontLoader {
...
+ (CGFloat)display4FontOpacity {
    return GTCTypographySecondaryOpacity;
}
...
+ (CGFloat)headlineFontOpacity {
    return GTCTypographyStandardOpacity;
}
...
+ (BOOL)isLargeForContrastRatios:(nonnull UIFont *)font {
    id<GTCTypographyFontLoading> fontLoader = [self fontLoader];
...
+ (id<GTCTypographyFontLoading>)defaultFontLoader {
    return [[GTCSystemFontLoader alloc] init];
}

@end

@interface GTCSystemFontLoader ()
...
@implementation GTCSystemFontLoader
...
- (BOOL)isLargeForContrastRatios:(UIFont *)font {
    ...
    CGFloat GTCFontWeightMedium = (CGFloat)0.23;
...
#pragma clang diagnostic ignored "-Wpartial-availability"
    if (&UIFontWeightMedium != NULL) {
        GTCFontWeightMedium = UIFontWeightMedium;
    }
#pragma clang diagnostic pop

    // We treat system font medium as large for accessibility when larger than 14.
    if (font.gtc_weight >= GTCFontWeightMedium) {
        return YES;
    }
