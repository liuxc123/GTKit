...
- (void)viewDidLoad {
  ...
  _styleFonts = @[
                  [UIFont gtc_standardFontForMaterialTextStyle:GTCFontTextStyleHeadline],
                  [UIFont gtc_preferredFontForMaterialTextStyle:GTCFontTextStyleHeadline],
                  [UIFont gtc_standardFontForMaterialTextStyle:GTCFontTextStyleTitle],
                  [UIFont gtc_preferredFontForMaterialTextStyle:GTCFontTextStyleTitle],
                  [UIFont gtc_standardFontForMaterialTextStyle:GTCFontTextStyleSubheadline],
                  [UIFont gtc_preferredFontForMaterialTextStyle:GTCFontTextStyleSubheadline],
                  [UIFont gtc_standardFontForMaterialTextStyle:GTCFontTextStyleBody2],
                  [UIFont gtc_preferredFontForMaterialTextStyle:GTCFontTextStyleBody2],
                  [UIFont gtc_standardFontForMaterialTextStyle:GTCFontTextStyleBody1],
                  [UIFont gtc_preferredFontForMaterialTextStyle:GTCFontTextStyleBody1],
                  [UIFont gtc_standardFontForMaterialTextStyle:GTCFontTextStyleCaption],
                  [UIFont gtc_preferredFontForMaterialTextStyle:GTCFontTextStyleCaption],
                  [UIFont gtc_standardFontForMaterialTextStyle:GTCFontTextStyleButton],
                  [UIFont gtc_preferredFontForMaterialTextStyle:GTCFontTextStyleButton],
                  [UIFont gtc_standardFontForMaterialTextStyle:GTCFontTextStyleDisplay1],
                  [UIFont gtc_preferredFontForMaterialTextStyle:GTCFontTextStyleDisplay1],
                  [UIFont gtc_standardFontForMaterialTextStyle:GTCFontTextStyleDisplay2],
                  [UIFont gtc_preferredFontForMaterialTextStyle:GTCFontTextStyleDisplay2],
                  [UIFont gtc_standardFontForMaterialTextStyle:GTCFontTextStyleDisplay3],
                  [UIFont gtc_preferredFontForMaterialTextStyle:GTCFontTextStyleDisplay3],
                  [UIFont gtc_standardFontForMaterialTextStyle:GTCFontTextStyleDisplay4],
                  [UIFont gtc_preferredFontForMaterialTextStyle:GTCFontTextStyleDisplay4]
                  ];
  ...
  */
  ...
  UIFont *defaultFont = [UIFont gtc_preferredFontForMaterialTextStyle:GTCFontTextStyleBody1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  if (cell.textLabel.font.pointSize > 100 && indexPath.section == 0) {
    cell.textLabel.text = @"Material Design Components";
  }
