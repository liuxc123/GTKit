...
/**
 GTCAppBarViewController is a flexible header view controller that manages a navigation bar and
 header stack view in order to provide the Material Top App Bar user interface.
 */
@interface GTCAppBarViewController : GTCFlexibleHeaderViewController
 ...
 */
@property(nonatomic, strong, nonnull) GTCNavigationBar *navigationBar;

/**
 The header stack view owns the navigationBar (as the top bar) and an optional bottom bar (typically
 a tab bar).
 */
@property(nonatomic, strong, nonnull) GTCHeaderStackView *headerStackView;
...
/**
 The GTCAppBar class creates and configures the constellation of components required to represent a
 Material App Bar.
 ...
 @warning This API will be deprecated in favor of GTCAppBarViewController. Learn more at
...
@property(nonatomic, strong, nonnull, readonly) GTCAppBarViewController *appBarViewController;

/** The navigation bar. */
@property(nonatomic, strong, nonnull, readonly) GTCNavigationBar *navigationBar;

/**
 The header stack view that owns the navigationBar (as the top bar) and an optional bottom bar.
 */
@property(nonatomic, strong, nonnull, readonly) GTCHeaderStackView *headerStackView;
...
/**
 ...
 See GTCFlexibleHeaderViewController's documentation for the API of the same name.
