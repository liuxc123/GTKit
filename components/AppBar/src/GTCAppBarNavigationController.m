//
//  GTCAppBarNavigationController.m
//  GTCatalog
//
...
@interface GTCAppBarNavigationControllerInfo: NSObject

@property(nonatomic, strong) GTCAppBar *appBar;
...
@implementation GTCAppBarNavigationControllerInfo
...
@implementation GTCAppBarNavigationController
...
- (UIViewController *)childViewControllerForStatusBarStyle {
    ...
    GTCAppBar *appBar = [self appBarForViewController:child];
    if (appBar) {
...
- (void)injectAppBarIntoViewController:(UIViewController *)viewController {
    ...
    GTCAppBar *appBar = [[GTCAppBar alloc] init];
    ...
    //    unregistered.
    GTCAppBarNavigationControllerInfo *info = [[GTCAppBarNavigationControllerInfo alloc] init];
    info.appBar = appBar;
...
- (BOOL)viewControllerHasFlexibleHeader:(UIViewController *)viewController {
    ...
    // case. GTCFlexibleHeaderViewController can never be a top-level view controller.
    for (UIViewController *childViewController in viewController.childViewControllers) {
        if ([childViewController isKindOfClass:[GTCFlexibleHeaderViewController class]]) {
            return YES;
        }
...
- (GTCAppBarNavigationControllerInfo *)infoForViewController:(UIViewController *)viewController {
    return objc_getAssociatedObject(viewController, _cmd);
}

- (void)setInfo:(GTCAppBarNavigationControllerInfo *)info
...
- (GTCAppBar *)appBarForViewController:(UIViewController *)viewController {
    return [self infoForViewController:viewController].appBar;
}

- (GTCAppBarViewController *)
