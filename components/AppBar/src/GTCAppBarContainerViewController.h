//
//  GTCAppBarContainerViewController.h
//  GTCatalog
//
...
/**
 The GTCAppBarContainerViewController controller provides an interface for placing a
 UIViewController behind an App Bar.

 The GTCAppBarContainerViewController class is commonly referred to as the "wrapper API" for the
 Material App Bar. This contrasts with the "injection" APIs as represented by the APIs in
 GTCAppBar.h.

 Use the GTCAppBarContainerViewController class when you do not own and cannot alter a view
 controller to which you want to add an App Bar. If you do own and can modify a view controller
 it is recommended that you use the GTCAppBar.h APIs instead.

 ### Why we recommend using the GTCAppBar.h APIs over this one
 ...
 */
@interface GTCAppBarContainerViewController : UIViewController
 ...
 */
@property(nonatomic, strong, nonnull, readonly) GTCAppBar *appBar;
