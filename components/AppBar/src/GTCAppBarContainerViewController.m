//
//  GTCAppBarContainerViewController.m
//  GTCatalog
//
...
@implementation GTCAppBarContainerViewController{
    GTCAppBar *_appBar;
}
...
- (GTCAppBarViewController *)appBarViewController {
