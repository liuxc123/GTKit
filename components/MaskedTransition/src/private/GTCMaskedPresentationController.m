//
//  GTCMaskedPresentationController.m
//  GTCatalog
//
...
@implementation GTCMaskedPresentationController{
...
- (void)presentationTransitionWillBegin {
    ...
    GTCMaskedTransitionMotionSpecForContext(self.containerView, self.presentedViewController);

    GTCMaskedTransitionMotionTiming motionTiming = motionSpecification.expansion;
...
- (void)dismissalTransitionWillBegin {
    ...
    if (motionSpecification.shouldSlideWhenCollapsed) {
        ...
        GTCMaskedTransitionMotionTiming motionTiming = motionSpecification.collapse;
