//
//  MaskedTransitionTypicalUse.swift
//  GTCatalog
//
...
import GTKitComponents.GTMaskedTransition
...
open class MaskedTransitionTypicalUseSwiftExample: UIViewController {
    ...
    let rightFAB = GTCFloatingButton()
    let leftFAB = GTCFloatingButton()
    ...
    override open func viewDidLoad() {
        ...
        GTCFloatingActionButtonThemer.applyScheme(buttonScheme, to: rightFAB)
        ...
        GTCFloatingActionButtonThemer.applyScheme(buttonScheme, to: leftFAB)
    ...
    var transitionController: GTCMaskedTransitionController? = nil
    @objc func didTapFab(fab: UIView) {
        ...
        let transitionController = GTCMaskedTransitionController(sourceView: fab)
...
extension MaskedTransitionTypicalUseSwiftExample {
    ...
    @objc class func catalogDescription() -> String {
        return "Examples of how the Floating Action Button can transition to other "
            + "on-screen views."
    }
