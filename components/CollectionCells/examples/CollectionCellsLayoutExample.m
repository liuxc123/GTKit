//
//  CollectionCellsLayoutExample.m
//  GTCatalog
//
...
@interface CollectionCellsLayoutExample ()
...
- (void)viewDidLoad {
    ...
    self.styler.cellStyle = GTCCollectionViewCellStyleGrouped;
    self.styler.cellLayoutType = GTCCollectionViewCellLayoutTypeList;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    if (model.checkMark) {
        cell.accessoryType = GTCCollectionViewCellAccessoryCheckmark;
    }
    if (model.circle) {
...
- (CGFloat)collectionView:(UICollectionView *)collectionView
    ...
    if (numberOfLines == 1) {
        ...
        return GTCCellDefaultTwoLineHeight;
    } else if (numberOfLines == 3) {
        return GTCCellDefaultThreeLineHeight;
    }
    return GTCCellDefaultOneLineHeight;
}
