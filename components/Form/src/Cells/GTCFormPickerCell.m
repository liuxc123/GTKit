...
@interface GTCFormPickerCell() <UIPickerViewDelegate, UIPickerViewDataSource>

@end

@implementation GTCFormPickerCell
...
{
    GTCFormRowDescriptor * formRow = self.inlineRowDescriptor ?: self.rowDescriptor;
    if (formRow.value){
