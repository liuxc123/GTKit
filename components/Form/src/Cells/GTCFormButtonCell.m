...
@implementation GTCFormButtonCell
...
- (void)formDescriptorCellDidSelectedWithFormController:(GTCFormViewController *)controller
{
    if (self.rowDescriptor.action.formBlock){
        ...
        if (controllerToPresent){
            if ([controllerToPresent conformsToProtocol:@protocol(GTCFormRowDescriptorViewController)]){
                ((UIViewController<GTCFormRowDescriptorViewController> *)controllerToPresent).rowDescriptor = self.rowDescriptor;
            }
            if (controller.navigationController == nil || [controllerToPresent isKindOfClass:[UINavigationController class]] || self.rowDescriptor.action.viewControllerPresentationMode == GTCFormPresentationModePresent){
