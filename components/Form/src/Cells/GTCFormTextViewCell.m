...
NSString *const GTCFormTextViewLengthPercentage = @"textViewLengthPercentage";
NSString *const GTCFormTextViewMaxNumberOfCharacters = @"textViewMaxNumberOfCharacters";

@interface GTCFormTextViewCell() <UITextViewDelegate>

@end

@implementation GTCFormTextViewCell
{
...
-(GTCFormTextView *)textView
{
    if (_textView) return _textView;
    _textView = [GTCFormTextView autolayoutView];
    return _textView;
}
