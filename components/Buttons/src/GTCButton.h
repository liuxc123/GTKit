...
/** Ink styles. */
typedef NS_ENUM(NSInteger, GTCButtonImagePosition) {
    GTCButtonImagePositionTop,    /** imageView with titleLabel top */
    GTCButtonImagePositionLeft,   /** imageView with titleLabel left */
    GTCButtonImagePositionBottom, /** imageView with titleLabel bottom */
    GTCButtonImagePositionRight   /** imageView with titleLabel right */
};
...
@property(nonatomic, assign) GTCInkStyle inkStyle UI_APPEARANCE_SELECTOR;
...
/*
 ...
 self.bounds is used. This value is ignored if button's @c inkStyle is set to |GTCInkStyleBounded|.
 */
...
/*
 ...
 If set to YES, this button will base its text font on GTCFontTextStyleButton.
...
/**
 ...
 When the shapeGenerator is nil, GTCButton will use the default underlying layer with
...
/**
 The imagePosition used to define the button's image position.

 note: Can cooperate imageEdgeInsets, titleEdgeInsets, contentHorizontalAlignment, contentVerticalAlignment use.

 Default value for imagePosition is GTCButtonImagePositionLeft.
 */
@property(nonatomic, assign) GTCButtonImagePosition imagePosition;

/**
 The spacingBetweenImageAndTitle used to define the button's image with text space.
 ...
 */
- (GTCShadowElevation)elevationForState:(UIControlState)state;
 ...
 */
- (void)setElevation:(GTCShadowElevation)elevation forState:(UIControlState)state;
