//
//  AnimationTimingExampleSupplemental.m
//  GTCatalog
//
...
- (void)setupExampleViews {
    ...
    [AnimationTimingExample curveLabelWithTitle:@"GTCAnimationTimingFunctionStandard"];
    ...
    [AnimationTimingExample curveLabelWithTitle:@"GTCAnimationTimingFunctionDeceleration"];
    ...
    [AnimationTimingExample curveLabelWithTitle:@"GTCAnimationTimingFunctionAcceleration"];
    ...
    [AnimationTimingExample curveLabelWithTitle:@"GTCAnimationTimingFunctionSharp"];
...
+ (UILabel *)curveLabelWithTitle:(NSString *)text {
    ...
    label.textColor = [UIColor colorWithWhite:0 alpha:[GTCTypography body2FontOpacity]];
    label.text = text;
    [label sizeToFit];
    return label;
}
