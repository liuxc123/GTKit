//
//  GTCDialogTransitionController.h
//  GTCatalog
//
...
/**
 GTCDialogTransitionController is be used to setup a custom transition and animationed presentation
 ...
 */
@interface GTCDialogTransitionController
