//
//  GTCDialogPresentationController.h
//  GTCatalog
//
...
/**
 GTCDialogPresentationController will present a modal ViewController as a dialog according to the
 Material spec.

 https://material.io/go/design-dialogs

 GTCDialogPresentationController should not be used to present full-screen dialogs.
 ...
 */
@interface GTCDialogPresentationController : UIPresentationController
