//
//  GTCDialogTransitionController.m
//  GTCatalog
//
...
@implementation GTCDialogTransitionController

static const NSTimeInterval GTCDialogTransitionDuration = 0.27;

#pragma mark - UIViewControllerAnimatedTransitioning

- (NSTimeInterval)transitionDuration:
(__unused id<UIViewControllerContextTransitioning>)transitionContext {
    return GTCDialogTransitionDuration;
}
...
- (UIPresentationController *) presentationControllerForPresentedViewController:(UIViewController *)presented
    ...
    return [[GTCDialogPresentationController alloc] initWithPresentedViewController:presented
