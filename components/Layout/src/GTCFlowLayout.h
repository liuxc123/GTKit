...
/**
 ...
 1.垂直数量约束流式布局
 orientation为GTCOrientationVert,arrangedCount不为0,支持wrapContentHeight,支持wrapContentWidth,不支持autoArrange。
 ...
 2.垂直内容约束流式布局.
 orientation为GTCOrientationVert,arrangedCount为0,支持wrapContentHeight,不支持wrapContentWidth,支持autoArrange。
 @code
 垂直内容约束流式布局
 =>
 +-----+-----------+
 ...
 3.水平数量约束流式布局。
 orientation为GTCOrientationHorz,arrangedCount不为0,支持wrapContentHeight,支持wrapContentWidth,不支持autoArrange。
 ...
 4.水平内容约束流式布局
 orientation为GTCOrientationHorz,arrangedCount为0,不支持wrapContentHeight,支持wrapContentWidth,支持autoArrange。
 ...
 */
@interface GTCFlowLayout : GTCBaseLayout
...
/**
 ...
 1. GTCOrientation_Vert 表示排内子视图从左到右(RTL从右到左)水平排列，排与排之间依次从上到下垂直排列。这个方向是默认方向。

 2. GTCOrientation_Horz 表示排内子视图从上到下垂直排列，排与排之间依次从左到右(RTL从右到左)水平排列。
 */
