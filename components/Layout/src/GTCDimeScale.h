 ...
 */
@interface GTCDimeScale : NSObject
...
#define GTCDIMESCALE(val)   ([GTCDimeScale scale:val])
#define GTCDIMESCALEW(val)  ([GTCDimeScale scaleW:val])
#define GTCDIMESCALEH(val)  ([GTCDimeScale scaleH:val])

#elif TARGET_OS_MAC

#define GTCDIMESCALE(val)   val
#define GTCDIMESCALEW(val)  val
#define GTCDIMESCALEH(val)  val
