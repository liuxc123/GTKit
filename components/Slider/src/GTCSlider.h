...
/**
 ...
 Differences between UISlider and GTCSlider:
 ...
 */
IB_DESIGNABLE
@interface GTCSlider : UIControl <NSSecureCoding>
...
@property(nullable, nonatomic, weak) id<GTCSliderDelegate> delegate;
...
/**
 ...
 Default value is GTCElevationNone.
 */
@property(nonatomic, assign) GTCShadowElevation thumbElevation UI_APPEARANCE_SELECTOR;
/**
...
/**
 ...
 implementing GTCSliderDelegate's @c -slider:displayedStringForValue: method to customize the string
...
/** GTCSlider delegate which allows setting custom behavior. */
@protocol GTCSliderDelegate <NSObject>
@optional

/**
 Called when the user taps on the GTCSlider.

 If not implemented, the GTCSlider will always be allowed to jump to any value.
 */
- (BOOL)slider:(nonnull GTCSlider *)slider shouldJumpToValue:(CGFloat)value;
...
/**
 ...
 @param slider The GTCSlider sender.
 @param value The value whose label needs to be calculated.
 */
- (nonnull NSString *)slider:(nonnull GTCSlider *)slider displayedStringForValue:(CGFloat)value;
 ...
 */
- (nonnull NSString *)slider:(nonnull GTCSlider *)slider accessibilityLabelForValue:(CGFloat)value;
