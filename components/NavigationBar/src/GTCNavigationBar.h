...
@protocol GTCButtonBarDelegate;

/** Specifies the title alignment of the |GTCNavigationBar|. */
typedef NS_ENUM(NSInteger, GTCNavigationBarTitleAlignment) {
    /** Aligns the title to the center of the NavigationBar. */
    GTCNavigationBarTitleAlignmentCenter,
    /** Aligns the title to the left/leading of the NavigationBar. */
    GTCNavigationBarTitleAlignmentLeading
};

/**
 Behaviors that affect the layout of an |GTCNavigationBar|'s titleView.
 */
typedef NS_ENUM(NSInteger, GTCNavigationBarTitleViewLayoutBehavior) {
    /**
     ...
     */
    GTCNavigationBarTitleViewLayoutBehaviorFill,

    /**
     Align the title view's center with the navigation bar's center, if possible.
     */
    GTCNavigationBarTitleViewLayoutBehaviorCenter
};
...
/**
 ...
 GTCNavigationBar.
 */
@protocol GTCUINavigationItemObservables <NSObject>
@required
...
@class GTCNavigationBar;

/**
 The GTCNavigationBarTextColorAccessibilityMutator class creates an external object with which to
...
@interface GTCNavigationBarTextColorAccessibilityMutator : NSObject
...
/**
 ...
 navigation bar.
 */
- (void)mutate:(nonnull GTCNavigationBar *)navBar;

@end

/**
 The GTCNavigationBar class is a view consisting of a leading and trailing button bar, title label,
 ...
 */
IB_DESIGNABLE
@interface GTCNavigationBar : UIView
...
/**
 ...
 Due to GTCNavigationBar being able to expand vertically, the titleView's height is updated to match
 any changes in the GTCNavigationBar's height.
...
/**
 ...
 By default this is GTCNavigationBarTitleViewLayoutBehaviorFill.
 */
@property(nonatomic) GTCNavigationBarTitleViewLayoutBehavior titleViewLayoutBehavior;

/**
 The font applied to the title of navigation bar.
 Font size is enforced to 20.
 Both Default and null_resettable value is GTCTypography's titleFont.
...
/**
 ...
 GTCNavigationBarTitleAlignmentLeading.
 */
@property(nonatomic) GTCNavigationBarTitleAlignment titleAlignment;
