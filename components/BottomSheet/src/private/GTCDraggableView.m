...
@interface GTCDraggableView ()<UIGestureRecognizerDelegate>
@property(nonatomic) UIPanGestureRecognizer *dragRecognizer;
@property(nonatomic, strong) UIScrollView *scrollView;
@end


@implementation GTCDraggableView
...
- (BOOL)gestureRecognizerShouldBegin:(UIPanGestureRecognizer *)recognizer {
    // When opening the control center while a GTCBottomSheet is displayed recognizer happens to be
