...
@protocol GTCBottomSheetControllerDelegate;
...
/**
 ...
 Show a bottom sheet by creating an GTCBottomSheetController instance with a contentViewController
 and presenting it with -[UIViewController presentViewController:animated:completion].
 GTCBottomSheetController automatically sets the appropriate presentation style and
 transitioningDelegate for the bottom sheet behavior.
 */
@interface GTCBottomSheetController : UIViewController
 ...
 */
@property(nonatomic, weak, nullable) id<GTCBottomSheetControllerDelegate> delegate;

/**
 The current state of the bottom sheet.
 */
@property(nonatomic, readonly) GTCSheetState state;
...
/**
 ...
 When the shapeGenerator for a state is nil, GTCBottomSheetController will use the default view's
 ...
 */
- (void)setShapeGenerator:(nullable id<GTCShapeGenerating>)shapeGenerator
                 forState:(GTCSheetState)state;

/**
 Returns the shape generator for an GTCSheetState state.

 @param state The state of the bottom sheet
 @return the shape generator for the state given.
 */
- (nullable id<GTCShapeGenerating>)shapeGeneratorForState:(GTCSheetState)state;
...
/**
 Delegate for GTCBottomSheetController.
 */
@protocol GTCBottomSheetControllerDelegate <NSObject>
...
/**
 ...
 @param controller The GTCBottomSheetController that was dismissed.
 */
- (void)bottomSheetControllerDidDismissBottomSheet:(nonnull GTCBottomSheetController *)controller;
