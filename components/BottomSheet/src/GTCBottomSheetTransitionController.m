//
//  GTCBottomSheetTransitionController.m
//  GTCatalog
//
...
static const NSTimeInterval GTCBottomSheetTransitionDuration = 0.25;

@implementation GTCBottomSheetTransitionController{
...
sourceViewController:(__unused UIViewController *)source {
    GTCBottomSheetPresentationController *presentationController =
    [[GTCBottomSheetPresentationController alloc] initWithPresentedViewController:presented
...
(nullable __unused id <UIViewControllerContextTransitioning>)transitionContext {
    return GTCBottomSheetTransitionDuration;
}
