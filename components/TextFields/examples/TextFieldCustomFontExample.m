...
@property(nonatomic) GTCTextInputControllerOutlined *systemFontController;
@property(nonatomic) GTCTextInputControllerOutlined *systemFontDynamicController;
@property(nonatomic) GTCTextInputControllerOutlined *customFontController;
@property(nonatomic) GTCTextInputControllerOutlined *customFontDynamicController;

@property(nonatomic) GTCTextInputControllerOutlinedTextArea *multilineController;
@property(nonatomic) GTCTextInputControllerOutlinedTextArea *multilineDynamicController;
@property(nonatomic) GTCTextInputControllerOutlinedTextArea *multilineCustomFontDynamicController;
...
- (void)viewDidLoad {
    ...
    GTCTextField *systemFontTextField = [self setupSystemFontTextField];

    // Create a System Font Dynamic TextField.
    GTCTextField *systemFontDynamicTextField = [self setupSystemFontDynamicTextField];

    // Create a Custom Font TextField.
    GTCTextField *customFontTextField = [self setupCustomFontTextField];;

    // Create a Custom Font Dynamic TextField.
    GTCTextField *customFontDynamicTextField = [self setupCustomFontDynamicTextField];;

    // Create a System Multiline TextField.
    GTCMultilineTextField *multilineTextField = [self setupSystemMultilineTextField];

    // Create a System Multiline Dynamic TextField.
    GTCMultilineTextField *multilineDynamicTextField = [self setupSystemMultilineDynamicTextField];

    // Create a Custom Multiline Dyamic TextField.
    GTCMultilineTextField *multilineCustomDynamicTextField =
...
- (GTCTextField *)setupSystemFontTextField {
    GTCTextField *systemFontTextField = [[GTCTextField alloc] init];
    ...
    self.systemFontController = [[GTCTextInputControllerOutlined alloc] initWithTextInput:systemFontTextField];
    self.systemFontController.placeholderText = @"System Font";
    self.systemFontController.gtc_adjustsFontForContentSizeCategory = NO;
    return systemFontTextField;
}

- (GTCTextField *)setupSystemFontDynamicTextField {
    GTCTextField *systemFontDynamicTextField = [[GTCTextField alloc] init];
    ...
    [[GTCTextInputControllerOutlined alloc] initWithTextInput:systemFontDynamicTextField];
    self.systemFontDynamicController.placeholderText = @"System Font - Dynamic";
    self.systemFontDynamicController.gtc_adjustsFontForContentSizeCategory = YES;
    return systemFontDynamicTextField;
}

- (GTCTextField *)setupCustomFontTextField {
    GTCTextField *customFontTextField = [[GTCTextField alloc] init];
    ...
    [[GTCTextInputControllerOutlined alloc] initWithTextInput:customFontTextField];
    self.customFontController.placeholderText = @"Custom Font";
    self.customFontController.gtc_adjustsFontForContentSizeCategory = NO;
...
- (GTCTextField *)setupCustomFontDynamicTextField {
    GTCTextField *customFontDynamicTextField = [[GTCTextField alloc] init];
    ...
    [[GTCTextInputControllerOutlined alloc] initWithTextInput:customFontDynamicTextField];
    ...
    self.customFontDynamicController.gtc_adjustsFontForContentSizeCategory = YES;

    [self.scrollView addSubview:customFontDynamicTextField];
    return customFontDynamicTextField;
}

- (GTCMultilineTextField *)setupSystemMultilineTextField {
    GTCMultilineTextField *multilineTextField = [[GTCMultilineTextField alloc] init];
    ...
    [[GTCTextInputControllerOutlinedTextArea alloc] initWithTextInput:multilineTextField];
    self.multilineController.placeholderText = @"Multiline Text";
    self.multilineController.gtc_adjustsFontForContentSizeCategory = NO;
    return multilineTextField;
}

- (GTCMultilineTextField *)setupSystemMultilineDynamicTextField {
    GTCMultilineTextField *multilineDynamicTextField = [[GTCMultilineTextField alloc] init];
    ...
    [[GTCTextInputControllerOutlinedTextArea alloc] initWithTextInput:multilineDynamicTextField];
    self.multilineDynamicController.placeholderText = @"Multiline Dynamic Text";
    self.multilineDynamicController.gtc_adjustsFontForContentSizeCategory = YES;
    return multilineDynamicTextField;
}

- (GTCMultilineTextField *)setupCustomMultilineDynamicTextField {
    GTCMultilineTextField *multilineCustomDynamicTextField = [[GTCMultilineTextField alloc] init];
    ...
    [[GTCTextInputControllerOutlinedTextArea alloc]
    ...
    self.multilineCustomFontDynamicController.gtc_adjustsFontForContentSizeCategory = YES;
