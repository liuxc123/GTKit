//
//  TextFieldKitchenSinkExampleSupplemental.swift
//  GTCatalog
//
...
extension TextFieldKitchenSinkSwiftExample {
    ...
    func setupExampleViews() {
        ...
        allTextFieldControllers = [setupFilledTextFields(), setupInlineUnderlineTextFields(),
                                   ...
                                   setupSpecialTextFields()].flatMap { $0 as! [GTCTextInputController] }
        ...
        allMultilineTextFieldControllers = [setupAreaTextFields(), setupUnderlineMultilineTextFields(),
                                            ...
                                            setupSpecialMultilineTextFields()].flatMap { $0 as! [GTCTextInputController] }
    ...
    func setupButton() -> GTCButton {
        let button = GTCButton()
        button.setTitleColor(.white, for: .normal)
        button.gtc_adjustsFontForContentSizeCategory = true
...
extension TextFieldKitchenSinkSwiftExample {
    ...
    @objc func textFieldModeButtonDidTouch(button: GTCButton) {
        ...
        let closure: (UITextFieldViewMode, String) -> Void = { mode, title in
            controllersToChange.forEach { controller in
                if button == self.characterModeButton {
                    ...
                    if let input = controller.textInput as? GTCTextField {
...
extension TextFieldKitchenSinkSwiftExample {
    ...
    @objc func textInsetsModeButtonDidTouch(button: GTCButton) {

        let closure: (GTCTextInputTextInsetsMode, String) -> Void = { mode, title in
        ...
        for rawMode: UInt in 0...2 {
            let mode = GTCTextInputTextInsetsMode(rawValue: rawMode)!
    ...
    func textInsetsModeName(mode: GTCTextInputTextInsetsMode) -> String {
        switch mode {
        case .always:
            return "Always"
        case .ifContent:
