...
final class TextFieldSemanticColorThemer: UIViewController {
    ...
    let textfieldStandard: GTCTextField = {
        let textfield = GTCTextField()
        textfield.translatesAutoresizingMaskIntoConstraints = false
        return textfield
    }()

    let textfieldAlternative: GTCTextField = {
        let textfield = GTCTextField()
        textfield.translatesAutoresizingMaskIntoConstraints = false
        return textfield
    }()

    let standardController: GTCTextInputControllerOutlined
    let alternativeController: GTCTextInputControllerFilled

    let scrollView = UIScrollView()

    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        standardController = GTCTextInputControllerOutlined(textInput: textfieldStandard)
        alternativeController = GTCTextInputControllerFilled(textInput: textfieldAlternative)
    ...
    override func viewDidLoad() {
        ...
        GTCOutlinedTextFieldColorThemer.applySemanticColorScheme(colorScheme, to: standardController)
        GTCTextFieldTypographyThemer.applyTypographyScheme(typographyScheme, to: standardController)

        GTCFilledTextFieldColorThemer.applySemanticColorScheme(colorScheme, to: alternativeController)
        GTCTextFieldTypographyThemer.applyTypographyScheme(typographyScheme, to: alternativeController)
    }
