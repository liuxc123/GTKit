...
final class TextFieldOutlinedSwiftExample: UIViewController {
    ...
    let cityController: GTCTextInputControllerOutlined
    ...
    let stateController: GTCTextInputControllerOutlined
    ...
    let zipController: GTCTextInputControllerOutlined
    ...
    var allTextFieldControllers = [GTCTextInputControllerFloatingPlaceholder]()
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        cityController = GTCTextInputControllerOutlined(textInput: city)
        stateController = GTCTextInputControllerOutlined(textInput: state)
        zipController = GTCTextInputControllerOutlined(textInput: zip)
    ...
    func setupTextFields() {
        ...
        let nameController = GTCTextInputControllerOutlined(textInput: name)
        name.delegate = self
        ...
        let addressController = GTCTextInputControllerOutlined(textInput: address)
        ...
        let phoneController = GTCTextInputControllerOutlined(textInput: phone)
        phone.delegate = self
        phoneController.placeholderText = "Phone Number"
        allTextFieldControllers.append(phoneController)

        scrollView.addSubview(message)
        let messageController = GTCTextInputControllerOutlinedTextArea(textInput: message)
    ...
    func style(textInputController : GTCTextInputController) {
        GTCOutlinedTextFieldColorThemer.applySemanticColorScheme(colorScheme, to: textInputController)
