...
import GTKitComponents.GTTextFields_ColorThemer
import GTKitComponents.GTTextFields_TypographyThemer

final class TextFieldFilledSwiftExample: UIViewController {

    let scrollView = UIScrollView()
    var colorScheme = GTCSemanticColorScheme()
    var typographyScheme = GTCTypographyScheme()
    ...
    let cityController: GTCTextInputControllerFilled
    ...
    let stateController: GTCTextInputControllerFilled
    ...
    let zipController: GTCTextInputControllerFilled
    ...
    var allTextFieldControllers = [GTCTextInputControllerFilled]()
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        cityController = GTCTextInputControllerFilled(textInput: city)
        stateController = GTCTextInputControllerFilled(textInput: state)
        zipController = GTCTextInputControllerFilled(textInput: zip)
    ...
    func style(textInputController:GTCTextInputControllerFilled) {
        GTCFilledTextFieldColorThemer.applySemanticColorScheme(colorScheme, to: textInputController)
        GTCTextFieldTypographyThemer.applyTypographyScheme(typographyScheme, to: textInputController)
        if let textInput = textInputController.textInput {
            GTCTextFieldTypographyThemer.applyTypographyScheme(typographyScheme, to: textInput)
        }
    }

    func setupTextFields() {
        scrollView.addSubview(name)
        let nameController = GTCTextInputControllerFilled(textInput: name)
        name.delegate = self
        ...
        let addressController = GTCTextInputControllerFilled(textInput: address)
        ...
        let phoneController = GTCTextInputControllerFilled(textInput: phone)
        phone.delegate = self
        phoneController.placeholderText = "Phone Number"
        allTextFieldControllers.append(phoneController)

        scrollView.addSubview(message)
        let messageController = GTCTextInputControllerFilled(textInput: message)
