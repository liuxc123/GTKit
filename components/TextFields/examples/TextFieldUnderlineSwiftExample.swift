//
//  TextFieldUnderlineSwiftExample.swift
//  GTCatalog
//
...
final class TextFieldUnderlineSwiftExample: UIViewController {
    ...
    let cityController: GTCTextInputControllerUnderline
    ...
    let stateController: GTCTextInputControllerUnderline
    ...
    let zipController: GTCTextInputControllerUnderline
    ...
    var allTextFieldControllers = [GTCTextInputControllerUnderline]()

    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        stateController = GTCTextInputControllerUnderline(textInput: state)
        cityController = GTCTextInputControllerUnderline(textInput: city)
        zipController = GTCTextInputControllerUnderline(textInput: zip)
    ...
    func setupTextFields() {
        ...
        let nameController = GTCTextInputControllerUnderline(textInput: name)
        name.delegate = self
        ...
        let addressController = GTCTextInputControllerUnderline(textInput: address)
        ...
        let phoneController = GTCTextInputControllerUnderline(textInput: phone)
        phone.delegate = self
        phoneController.placeholderText = "Phone Number"
        allTextFieldControllers.append(phoneController)

        scrollView.addSubview(message)
        let messageController = GTCTextInputControllerUnderline(textInput: message)
...
extension TextFieldUnderlineSwiftExample: GTCMultilineTextInputDelegate {
