...
extern const CGFloat GTCTextInputControllerBaseDefaultBorderRadius;
 ...
 */
@interface GTCTextInputControllerBase : NSObject <GTCTextInputControllerFloatingPlaceholder>
...
/**
 ...
 If the text input does not conform to GTCMultilineTextInput, this parameter has no effect.
