...
static const CGFloat GTCTextInputClearButtonImageBuiltInPadding = 2.0f;
...
static inline UIBezierPath *GTCPathForClearButtonLegacyImageFrame(CGRect frame) {
    // GENERATED CODE

    CGRect innerBounds = CGRectMake(CGRectGetMinX(frame) + 10, CGRectGetMinY(frame) + 10,
                                    GTCFloor((frame.size.width - 10) * 0.73684f + 0.5f),
                                    GTCFloor((frame.size.height - 10) * 0.73684f + 0.5f));
