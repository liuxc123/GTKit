...
const CGFloat GTCTextInputControllerBaseDefaultBorderRadius = 4.f;
static const CGFloat GTCTextInputControllerBaseDefaultFloatingPlaceholderScaleDefault = 0.75f;
static const CGFloat GTCTextInputControllerBaseDefaultHintTextOpacity = 0.54f;
static const CGFloat GTCTextInputControllerBaseDefaultPadding = 8.f;

static const NSTimeInterval
GTCTextInputControllerBaseDefaultFloatingPlaceholderDownAnimationDuration = 0.266666f;
static const NSTimeInterval
GTCTextInputControllerBaseDefaultFloatingPlaceholderUpAnimationDuration = 0.3f;

static inline UIColor *GTCTextInputControllerBaseDefaultInlinePlaceholderTextColorDefault() {
    return [UIColor colorWithWhite:0 alpha:GTCTextInputControllerBaseDefaultHintTextOpacity];
}

static inline UIColor *GTCTextInputControllerBaseDefaultActiveColorDefault() {
    return [GTCPalette bluePalette].accent700;
}

static inline UIColor *GTCTextInputControllerBaseDefaultNormalUnderlineColorDefault() {
    return [UIColor lightGrayColor];
}

static inline UIColor *GTCTextInputControllerBaseDefaultTextErrorColorDefault() {
    return [GTCPalette redPalette].accent400;
}

#pragma mark - Class Properties

static BOOL _floatingEnabledDefault = YES;
static BOOL _gtc_adjustsFontForContentSizeCategoryDefault = NO;

static CGFloat _floatingPlaceholderScaleDefault =
GTCTextInputControllerBaseDefaultFloatingPlaceholderScaleDefault;
...
@interface GTCTextInputControllerBase () {
    ...
    GTCTextInputAllCharactersCounter *_characterCounter;
...
@property(nonatomic, strong) GTCTextInputAllCharactersCounter *internalCharacterCounter;
...
@implementation GTCTextInputControllerBase
...
- (instancetype)init {
    self = [super init];
    if (self) {
        if ([self isMemberOfClass:[GTCTextInputControllerBase class]]) {
            NSLog(@"NOTE: GTCTextInputControllerBase is a base class meant to be subclassed.\nFor more"
                  "information, see the README.md file");
        }
        [self commonGTCTextInputControllerBaseInitialization];
    }
...
- (instancetype)initWithTextInput:(UIView<GTCTextInput> *)textInput {
    self = [self init];
    if (self) {
...
- (instancetype)copyWithZone:(__unused NSZone *)zone {
    GTCTextInputControllerBase *copy = [[[self class] alloc] init];
...
- (void)commonGTCTextInputControllerBaseInitialization {
    ...
    _internalCharacterCounter = [[GTCTextInputAllCharactersCounter alloc] init];
    _minimumLines = 1;
...
- (void)setupInput {
    ...
    _textInput.gtc_adjustsFontForContentSizeCategory ||
    [self class].gtc_adjustsFontForContentSizeCategoryDefault;
    _textInput.underline.disabledColor = self.disabledColor;
    _textInput.gtc_adjustsFontForContentSizeCategory = NO;
    ...
    if ([_textInput conformsToProtocol:@protocol(GTCMultilineTextInput)] &&
        [_textInput respondsToSelector:@selector(setMinimumLines:)]) {
        ((id<GTCMultilineTextInput>)_textInput).minimumLines = self.minimumLines;
    }

    if ([_textInput conformsToProtocol:@protocol(GTCMultilineTextInput)] &&
        [_textInput respondsToSelector:@selector(setExpandsOnOverflow:)]) {
        ((id<GTCMultilineTextInput>)_textInput).expandsOnOverflow = self.expandsOnOverflow;
    }
...
- (GTCTextInputTextInsetsMode)textInsetModeDefault {
    return GTCTextInputTextInsetsModeAlways;
}
...
- (void)subscribeForNotifications {
    ...
    [defaultCenter addObserver:self
                      selector:@selector(textInputDidToggleEnabled:)
                          name:GTCTextInputDidToggleEnabledNotification
                        object:_textInput];
    ...
    if ([_textInput isKindOfClass:[GTCMultilineTextField class]]) {
        GTCMultilineTextField *textField = (GTCMultilineTextField *)_textInput;
        [defaultCenter addObserver:self
                          selector:@selector(textInputDidBeginEditing:)
...
- (UIBezierPath *)defaultBorderPath {
    ...
    return [UIBezierPath
            ...
            cornerRadii:CGSizeMake(GTCTextInputControllerBaseDefaultBorderRadius,
...
- (id<GTCTextInputCharacterCounter>)characterCounter {
...
- (void)setCharacterCounter:(id<GTCTextInputCharacterCounter>)characterCounter {
...
- (void)updateLeadingUnderlineLabel {
    ...
    if (self.gtc_adjustsFontForContentSizeCategory) {
        ...
        font = [font gtc_fontSizedForMaterialTextStyle:GTCFontTextStyleCaption
...
- (void)updateTextInput {
    ...
    if (self.gtc_adjustsFontForContentSizeCategory) {
        font = [font gtc_fontSizedForMaterialTextStyle:GTCFontTextStyleBody1
                                  scaledForDynamicType:_gtc_adjustsFontForContentSizeCategory];
        // TODO: (#4331) This needs to be converted to the new text scheme.
    }
...
- (void)updatePlaceholder {
    ...
    if (self.gtc_adjustsFontForContentSizeCategory) {
        // TODO: (#4331) This needs to be converted to the new text scheme.
        placeHolderFont =
        [placeHolderFont gtc_fontSizedForMaterialTextStyle:GTCFontTextStyleBody1
                                      scaledForDynamicType:_gtc_adjustsFontForContentSizeCategory];
    ...
    if (![self.textInput.placeholderLabel.font gtc_isSimplyEqual:placeHolderFont]){
...
- (UIOffset)floatingPlaceholderOffset {
    CGFloat vertical = GTCTextInputControllerBaseDefaultPadding;
...
- (void)updateTrailingUnderlineLabel {
    if (!self.characterCountMax) {
        ...
        if (self.gtc_adjustsFontForContentSizeCategory) {
            // TODO: (#4331) This needs to be converted to the new text scheme.
            font =
            [font gtc_fontSizedForMaterialTextStyle:GTCFontTextStyleCaption
                               scaledForDynamicType:_gtc_adjustsFontForContentSizeCategory];
        }
...
+ (UIFont *)placeholderFont {
    return [UIFont gtc_standardFontForMaterialTextStyle:GTCFontTextStyleBody1];
    // TODO: (#4331) This needs to be converted to the new text scheme.
}
...
+ (UIColor *)activeColorDefault {
    if (!_activeColorDefault) {
        _activeColorDefault = GTCTextInputControllerBaseDefaultActiveColorDefault();
    }
...
+ (void)setActiveColorDefault:(UIColor *)activeColorDefault {
    ...
    : GTCTextInputControllerBaseDefaultActiveColorDefault();
}
...
+ (UIColor *)disabledColorDefault {
    if (!_disabledColorDefault) {
        _disabledColorDefault = GTCTextInputControllerBaseDefaultNormalUnderlineColorDefault();
    }
...
+ (void)setDisabledColorDefault:(UIColor *)disabledColorDefault {
    ...
    : GTCTextInputControllerBaseDefaultNormalUnderlineColorDefault();
}
...
+ (UIColor *)errorColorDefault {
    if (!_errorColorDefault) {
        _errorColorDefault = GTCTextInputControllerBaseDefaultTextErrorColorDefault();
    }
...
+ (void)setErrorColorDefault:(UIColor *)errorColorDefault {
    ...
    : GTCTextInputControllerBaseDefaultTextErrorColorDefault();
}
...
- (void)setExpandsOnOverflow:(BOOL)expandsOnOverflow {
    if (_expandsOnOverflow != expandsOnOverflow) {
        ...
        if ([_textInput conformsToProtocol:@protocol(GTCMultilineTextInput)] &&
            [_textInput respondsToSelector:@selector(setExpandsOnOverflow:)]) {
            ((id<GTCMultilineTextInput>)_textInput).expandsOnOverflow = expandsOnOverflow;
        }
    }
}
...
+ (UIColor *)inlinePlaceholderColorDefault {
    if (!_inlinePlaceholderColorDefault) {
        ...
        GTCTextInputControllerBaseDefaultInlinePlaceholderTextColorDefault();
    }
...
- (void)setMinimumLines:(NSUInteger)minimumLines {
    if (_minimumLines != minimumLines) {
        ...
        if ([_textInput conformsToProtocol:@protocol(GTCMultilineTextInput)] &&
            [_textInput respondsToSelector:@selector(setMinimumLines:)]) {
            ((id<GTCMultilineTextInput>)_textInput).minimumLines = minimumLines;
        }
    }
}
...
+ (UIColor *)normalColorDefault {
    if (!_normalColorDefault) {
        _normalColorDefault = GTCTextInputControllerBaseDefaultNormalUnderlineColorDefault();
    }
...
#pragma mark - GTCTextFieldPositioningDelegate
...
/**
 ...
 GTCTextInputControllerBaseDefaultPadding                             // Top padding
 GTCRint(self.textInput.placeholderLabel.font.lineHeight * scale)     // Placeholder when up
 GTCTextInputControllerBaseDefaultPadding                             // Padding
 GTCCeil(MAX(self.textInput.font.lineHeight,                          // Text field or placeholder
 self.textInput.placeholderLabel.font.lineHeight))
 GTCTextInputControllerBaseDefaultPadding                             // Padding to underline
...
- (UIEdgeInsets)textInsets:(UIEdgeInsets)defaultInsets {
    ...
    textInsets.top = GTCTextInputControllerBaseDefaultPadding +
    GTCRint(self.textInput.placeholderLabel.font.lineHeight *
            (CGFloat)self.floatingPlaceholderScale.floatValue) +
    GTCTextInputControllerBaseDefaultPadding;
    ...
    // GTCTextInputControllerBaseDefaultPadding or the biggest estimated underlineLabel height +
    // GTCTextInputControllerBaseDefaultPadding. It's also dependent on the .textInsetsMode.
    CGFloat underlineOffset = 0;
    switch (self.textInput.textInsetsMode) {
        case GTCTextInputTextInsetsModeAlways:
            underlineOffset +=
            MAX(leadingOffset, trailingOffset) + GTCTextInputControllerBaseDefaultPadding;
            break;
        case GTCTextInputTextInsetsModeIfContent: {
            ...
            if (!GTCCGFloatEqual(contentConditionalOffset, 0)) {
                underlineOffset += contentConditionalOffset + GTCTextInputControllerBaseDefaultPadding;
            }
        } break;
    ...
    // .bottom = underlineOffset + GTCTextInputControllerBaseDefaultPadding
    // Legacy default has an additional padding here but this version does not.
    textInsets.bottom = underlineOffset + GTCTextInputControllerBaseDefaultPadding;
...
- (void)textInputDidBeginEditing:(__unused NSNotification *)note {
    [CATransaction begin];
    [CATransaction
     setAnimationDuration:GTCTextInputControllerBaseDefaultFloatingPlaceholderUpAnimationDuration];
    [CATransaction
     setAnimationTimingFunction:[CAMediaTimingFunction
                                 gtc_functionWithType:GTCAnimationTimingFunctionEaseInOut]];
...
- (void)textInputDidChange:(NSNotification *)note {
    if ([note.name isEqualToString:GTCTextFieldTextDidSetTextNotification]) {
        [CATransaction begin];
...
- (void)textInputDidEndEditing:(__unused NSNotification *)note {
    ...
    [CATransaction setAnimationDuration:
     GTCTextInputControllerBaseDefaultFloatingPlaceholderDownAnimationDuration];
    [CATransaction
     setAnimationTimingFunction:[CAMediaTimingFunction
                                 gtc_functionWithType:GTCAnimationTimingFunctionEaseInOut]];
...
+ (BOOL)gtc_adjustsFontForContentSizeCategoryDefault {
    return _gtc_adjustsFontForContentSizeCategoryDefault;
}

+ (void)setGtc_adjustsFontForContentSizeCategoryDefault:
(BOOL)gtc_adjustsFontForContentSizeCategoryDefault {
    _gtc_adjustsFontForContentSizeCategoryDefault = gtc_adjustsFontForContentSizeCategoryDefault;
}
