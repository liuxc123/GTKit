...
/**
 ...
 - For handling error states and other Material behaviors use an GTCTextInputController on your
 inputs.
 ...
 */
typedef NS_ENUM(NSUInteger, GTCTextInputTextInsetsMode) {
    GTCTextInputTextInsetsModeNever = 0,
    GTCTextInputTextInsetsModeIfContent,
    GTCTextInputTextInsetsModeAlways,
};

@class GTCTextInputBorderView;
@class GTCTextInputUnderlineView;

@protocol GTCTextInputPositioningDelegate;

/** Common API for Material Design compliant text inputs. */
@protocol GTCTextInput <NSObject>

/**
 The attributed text string of the placeholder label.
 Bringing convenience api found in UITextField to all GTCTextInputs. Maps to the .attributedText of
 the
 placeholder label.
 */
...
@property(nonatomic, nullable, strong) GTCTextInputBorderView *borderView;
...
/**
 ...
 Default is [GTCPalette bluePalette].accent700.
 */
...
/*
 ...
 Default value is NO.
 */
@property(nonatomic, setter=gtc_setAdjustsFontForContentSizeCategory:)
 ...
 */
@property(nonatomic, nullable, weak) id<GTCTextInputPositioningDelegate> positioningDelegate;
...
/**
 ...
 GTCTextInputTextInsetsModeNever:      Text insets never includes the labels.

 GTCTextInputTextInsetsModeIfContent:  Text insets height includes space for each label that has
 text.

 GTCTextInputTextInsetsModeAlways:     Text insets always includes the labels.

 Default is GTCTextInputTextInsetsModeIfContent.
 */
@property(nonatomic, assign) GTCTextInputTextInsetsMode textInsetsMode UI_APPEARANCE_SELECTOR;
...
/** The underline view */
@property(nonatomic, nullable, strong, readonly) GTCTextInputUnderlineView *underline;
...
/**
 ...
 GTCTextField implements this protocol but GTCMultilineTextField does not because the designers
 determined multiline text fields should only have trailing views.
 */
@protocol GTCLeadingViewTextInput <GTCTextInput>
...
@protocol GTCMultilineTextInput <GTCTextInput>
