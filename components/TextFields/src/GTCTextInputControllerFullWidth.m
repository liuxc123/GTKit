//
//  GTCTextInputControllerFullWidth.m
//  GTCatalog
//
...
static const CGFloat GTCTextInputControllerFullWidthHintTextOpacity = 0.54f;
static const CGFloat GTCTextInputControllerFullWidthHorizontalInnerPadding = 8.f;
static const CGFloat GTCTextInputControllerFullWidthHorizontalPadding = 16.f;
static const CGFloat GTCTextInputControllerFullWidthVerticalPadding = 20.f;

static inline UIColor *GTCTextInputControllerFullWidthInlinePlaceholderTextColorDefault() {
    return [UIColor colorWithWhite:0 alpha:GTCTextInputControllerFullWidthHintTextOpacity];
}

static inline UIColor *GTCTextInputControllerFullWidthErrorColorDefault() {
...
@implementation GTCTextInputControllerFullWidth
...
- (instancetype)init {
    self = [super init];
    if (self) {
        [self commonGTCTextInputControllerFullWidthInitialization];
    }
...
- (instancetype)copyWithZone:(__unused NSZone *)zone {
    GTCTextInputControllerFullWidth *copy = [[[self class] alloc] init];
...
- (void)commonGTCTextInputControllerFullWidthInitialization {
...
- (void)updateTextInput {
    ...
    if (self.gtc_adjustsFontForContentSizeCategory) {
        ...
        font =
        [font gtc_fontSizedForMaterialTextStyle:GTCFontTextStyleBody1
...
+ (UIColor *)errorColorDefault {
    if (!_errorColorDefault) {
        _errorColorDefault = GTCTextInputControllerFullWidthErrorColorDefault();
    }
...
+ (void)setErrorColorDefault:(UIColor *)errorColorDefault {
    _errorColorDefault =
    errorColorDefault ? errorColorDefault : GTCTextInputControllerFullWidthErrorColorDefault();
}
...
+ (UIColor *)inlinePlaceholderColorDefault {
    if (!_inlinePlaceholderColorDefault) {
        ...
        GTCTextInputControllerFullWidthInlinePlaceholderTextColorDefault();
    }
...
- (void)updateConstraints {
    if (!self.characterCountTrailing) {
        self.characterCountTrailing = [NSLayoutConstraint
                                       ...
                                       attribute:NSLayoutAttributeTrailing
                                       multiplier:1
                                       constant:-1 * GTCTextInputControllerFullWidthHorizontalPadding];
    }
    ...
    if (!self.placeholderLeading) {
        ...
        [NSLayoutConstraint constraintWithItem:self.textInput.placeholderLabel
                                     ...
                                     attribute:NSLayoutAttributeLeading
                                    multiplier:1
                                      constant:GTCTextInputControllerFullWidthHorizontalPadding];
    }
    if (!self.placeholderTrailingCharacterCountLeading) {
        self.placeholderTrailingCharacterCountLeading = [NSLayoutConstraint
                                                         ...
                                                         attribute:NSLayoutAttributeLeading
                                                         multiplier:1
                                                         constant:-1 * GTCTextInputControllerFullWidthHorizontalInnerPadding];
    }
    ...
    if ([self.textInput isKindOfClass:[GTCMultilineTextField class]]) {
        ...
        if (!self.multilineTextViewBottom) {
            self.multilineTextViewBottom = [NSLayoutConstraint
                                            constraintWithItem:((GTCMultilineTextField *)self.textInput).textView
                                            attribute:NSLayoutAttributeBottom
                                            relatedBy:NSLayoutRelationEqual
                                            toItem:self.textInput
                                            attribute:NSLayoutAttributeBottom
                                            multiplier:1
                                            constant:-1 * GTCTextInputControllerFullWidthVerticalPadding];
        }
        if (!self.multilineTextViewTop) {
            self.multilineTextViewTop =
            [NSLayoutConstraint constraintWithItem:((GTCMultilineTextField *)self.textInput).textView
                                         attribute:NSLayoutAttributeTop
                                         relatedBy:NSLayoutRelationEqual
                                            toItem:self.textInput
                                         attribute:NSLayoutAttributeTop
                                        multiplier:1
                                          constant:GTCTextInputControllerFullWidthVerticalPadding];
        }
        ...
        GTCCeil(((GTCMultilineTextField *)self.textInput).textView.font.lineHeight * scale) / scale;
...
/**
 ...
 GTCTextInputControllerFullWidthVerticalPadding                       // Top padding
 GTCRint(MAX(self.textInput.font.lineHeight,                          // Text field or placeholder
 self.textInput.placeholderLabel.font.lineHeight))
 GTCTextInputControllerFullWidthVerticalPadding                       // Bottom padding
 */
// clang-format on
- (UIEdgeInsets)textInsets:(__unused UIEdgeInsets)defaultInsets {
    ...
    textInsets.top = GTCTextInputControllerFullWidthVerticalPadding;
    textInsets.bottom = GTCTextInputControllerFullWidthVerticalPadding;
    textInsets.left = GTCTextInputControllerFullWidthHorizontalPadding;
    textInsets.right = GTCTextInputControllerFullWidthHorizontalPadding;
    ...
    if (CGRectGetWidth(self.textInput.trailingUnderlineLabel.frame) > 1.f) {
        textInsets.right += GTCCeil(CGRectGetWidth(self.textInput.trailingUnderlineLabel.frame));
        ...
        CGRect charCountRect = [[self characterCountText]
                                ...
                                context:nil];
        textInsets.right += GTCCeil(CGRectGetWidth(charCountRect));
    }
    ...
    if (self.textInput.text.length > 0) {
        switch (textField.clearButtonMode) {
            ...
            case UITextFieldViewModeUnlessEditing:
                ...
                editingRect.size.width += CGRectGetWidth(self.textInput.clearButton.bounds);
                editingRect.size.width -= GTCTextInputControllerFullWidthHorizontalInnerPadding;
                break;
            default:
                break;
        }
