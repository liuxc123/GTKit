//
//  GTCTextInputPositioningDelegate.h
//  GTCatalog
//
...
/**
 GTCTextInputPositioningDelegate allows objects outside an GTCTextInput, like
 GTCTextInputController, to pass the GTCTextInput important layout information.

 Usually, these methods are direct mirrors of internal methods with the addition of a default value.
 */

@protocol GTCTextInputPositioningDelegate <NSObject>
...
/**
 ...
 @param defaultInsets The value of text container insets that the GTCTextInput has calculated by
 default.
 */
