...
@protocol GTCTextInputCharacterCounter;

/** Controllers that manipulate styling and animation of text inputs. */
@protocol GTCTextInputController  <NSObject, NSCopying, GTCTextInputPositioningDelegate>
...
/**
 ...
 Default is an internal instance GTCTextInputAllCharactersCounter. Setting this property to null
 will reset it to return that instance.
 */
@property(nonatomic, null_resettable, weak) IBInspectable id<GTCTextInputCharacterCounter>
characterCounter;
...
/**
 ...
 Note: setErrorText:errorAccessibilityValue: also sets these GTCTextInput properties.
...
/*
 ...
 Default is gtc_adjustsFontForContentSizeCategoryDefault.
 */
@property(nonatomic, assign, readwrite, setter=gtc_setAdjustsFontForContentSizeCategory:)
BOOL gtc_adjustsFontForContentSizeCategory;

/** Default value for gtc_adjustsFontForContentSizeCategory. */
@property(class, nonatomic, assign) BOOL gtc_adjustsFontForContentSizeCategoryDefault;
...
@property(nonatomic, nullable, strong) UIView<GTCTextInput> *textInput;
...
/**
 ...
 @param input An GTCTextInput this controller will manage.
 */
- (nonnull instancetype)initWithTextInput:(nullable UIView<GTCTextInput> *)input;
...
/**
 ...
 This method is usually called from whatever object is the UITextFieldDelegate for the GTCTextField.
 ...
 Note: The characterCountMax property also affects these same GTCTextInput properties.
 */
