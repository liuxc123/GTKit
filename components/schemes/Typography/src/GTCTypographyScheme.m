...
@implementation GTCTypographyScheme

- (instancetype)init {
    return [self initWithDefaults:GTCTypographySchemeDefaultsMaterial201804];
}

- (instancetype)initWithDefaults:(GTCTypographySchemeDefaults)defaults {
    self = [super init];
    if (self) {
        switch (defaults) {
            case GTCTypographySchemeDefaultsMaterial201804:
