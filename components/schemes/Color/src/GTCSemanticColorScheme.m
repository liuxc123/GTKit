...
@implementation GTCSemanticColorScheme

- (instancetype)init {
    return [self initWithDefaults:GTCColorSchemeDefaultsMaterial201804];
}

- (instancetype)initWithDefaults:(GTCColorSchemeDefaults)defaults {
    self = [super init];
    if (self) {
        switch (defaults) {
            case GTCColorSchemeDefaultsMaterial201804:
