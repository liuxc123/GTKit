...
@interface GTCInkTouchController ()
@property(nonatomic, strong) GTCInkView *addedInkView;
@property(nonatomic, strong) GTCInkView *defaultInkView;
@property(nonatomic, assign) BOOL shouldRespondToTouch;
@property(nonatomic, assign) CGPoint previousLocation;
@end

@protocol GTCInkTouchControllerLegacyDelegate <NSObject>
@optional
...
(nonnull GTCInkTouchController *)inkTouchController
...
@implementation GTCInkTouchController
...
- (instancetype)initWithView:(UIView *)view {
    ...
    if (self) {
        _gestureRecognizer =
        [[GTCInkGestureRecognizer alloc] initWithTarget:self action:@selector(handleInkGesture:)];
        _gestureRecognizer.delegate = self;

        _view = view;
        [_view addGestureRecognizer:_gestureRecognizer];

        _defaultInkView = [[GTCInkView alloc] initWithFrame:view.bounds];
...
- (void)handleInkGesture:(GTCInkGestureRecognizer *)recognizer {
...
- (void)cancelInkGestureWithRecognizer:(GTCInkGestureRecognizer *)recognizer {
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer {
    if ([_delegate respondsToSelector:@selector(inkTouchController:
        ...
        id<GTCInkTouchControllerLegacyDelegate> legacyDelegate =
        (id<GTCInkTouchControllerLegacyDelegate>)_delegate;
