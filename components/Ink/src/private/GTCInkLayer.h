 ...
 */
@interface GTCInkLayer : CAShapeLayer
 ...
 */
@property(nonatomic, weak, nullable) id<GTCInkLayerDelegate> animationDelegate;
...
/**
 Delegate protocol for the GTCInkLayer. Clients may implement this protocol to receive updates when
 ink layer animations start and end.
 */
@protocol GTCInkLayerDelegate <CALayerDelegate>
...
/**
 ...
 @param inkLayer The GTCInkLayer that starts animating.
 */
- (void)inkLayerAnimationDidStart:(nonnull GTCInkLayer *)inkLayer;

/**
 Called when the ink ripple animation ends.

 @param inkLayer The GTCInkLayer that ends animating.
 */
- (void)inkLayerAnimationDidEnd:(nonnull GTCInkLayer *)inkLayer;
