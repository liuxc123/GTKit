...
@class GTCInkGestureRecognizer;
@class GTCInkTouchController;
@class GTCInkView;
@protocol GTCInkTouchControllerDelegate;

/**
 GTCInkTouchController associates a GTCInkView with a UIGestureRecognizer to control the spread of
 the ink.
 ...
 */
@interface GTCInkTouchController : NSObject <UIGestureRecognizerDelegate>
 ...
 */
@property(nonatomic, strong, readonly, nonnull) GTCInkView *defaultInkView;

/** Delegate to extend the behavior of the touch control. */
@property(nonatomic, weak, nullable) id<GTCInkTouchControllerDelegate> delegate;
...
@property(nonatomic, strong, readonly, nonnull) GTCInkGestureRecognizer *gestureRecognizer;
 ...
 */
- (GTCInkView *_Nullable)inkViewAtTouchLocation:(CGPoint)location;

@end

/** Delegate methods for GTCInkTouchController. */
@protocol GTCInkTouchControllerDelegate <NSObject>
@optional
 ...
 */
- (void)inkTouchController:(nonnull GTCInkTouchController *)inkTouchController
 ...
 */
- (nullable GTCInkView *)inkTouchController:(nonnull GTCInkTouchController *)inkTouchController
 ...
 */
- (BOOL)inkTouchController:(nonnull GTCInkTouchController *)inkTouchController
 ...
 */
- (void)inkTouchController:(nonnull GTCInkTouchController *)inkTouchController
         didProcessInkView:(nonnull GTCInkView *)inkView
