 ...
 */
@interface GTCChipView : UIControl
 ...
 */
@property(nullable, nonatomic, strong) id<GTCShapeGenerating> shapeGenerator UI_APPEARANCE_SELECTOR;
...
/*
 ...
 set for UIControlStateNormal. Defaults to nil. When nil GTCInkView.defaultInkColor is used.
