...
/**
 ...
 Default: GTCBarButtonLayoutPositionNone
 */
typedef NS_OPTIONS(NSUInteger, GTCButtonBarLayoutPosition) {
    GTCButtonBarLayoutPositionNone = 0,

    /** The button bar is on the leading side of the screen. */
    GTCButtonBarLayoutPositionLeading = 1 << 0,
    GTCButtonBarLayoutPositionLeft = GTCButtonBarLayoutPositionLeading,

    /** The button bar is on the trailing side of the screen. */
    GTCButtonBarLayoutPositionTrailing = 1 << 1,
    GTCButtonBarLayoutPositionRight = GTCButtonBarLayoutPositionTrailing,
};

@protocol GTCButtonBarDelegate;

/**
 The GTCButtonBar class provides a view comprised of a horizontal list of buttons.
 ...
 If any of the above properties change, the GTCButtonBar will immediately reflect the change
...
/**
 ...
 GTCButtonBar is not able to associate UIBarButtonItem instances with their corresponding UIButton
...
/**
 ...
 Default: GTCBarButtonLayoutPositionNone
 */
@property(nonatomic) GTCButtonBarLayoutPosition layoutPosition;
...
typedef NS_OPTIONS(NSUInteger, GTCBarButtonItemLayoutHints) {
    ...
    GTCBarButtonItemLayoutHintsIsFirstButton = 1 << 0,

    /** Whether or not this bar button item is the last button in the list. */
    GTCBarButtonItemLayoutHintsIsLastButton = 1 << 1,
};

/**
 The GTCButtonBarDelegate protocol defines the means by which GTCButtonBar can request that a
 ...
 importing the GTCAppBarButtonBarBuilder.h header. The GTCAppBarButtonBarBuilder.h header should
 *only* be
 imported in files that implement objects conforming to GTCButtonBarDelegate.
