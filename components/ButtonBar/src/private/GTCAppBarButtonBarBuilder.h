...
/** GTCBarButtonItemBuilder is an implementation of a Material button item factory. */
@interface GTCAppBarButtonBarBuilder : NSObject <GTCButtonBarDelegate>
