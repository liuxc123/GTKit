//
//  GTCCollectionViewStyler.m
//  GTCatalog
//
//  Created by liuxc on 2018/8/29.
//

#import "GTCCollectionViewStyler.h"
...
const CGFloat GTCCollectionViewCellStyleCardSectionInset = 8.0f;
...
@interface GTCCollectionViewStyler ()
...
@implementation GTCCollectionViewStyler
...
- (instancetype)initWithCollectionView:(UICollectionView *)collectionView {
    ...
    if (self) {
        ...
        _cellStyle = GTCCollectionViewCellStyleDefault;
        // Background color is 0xEEEEEE
        _collectionView.backgroundColor = GTCPalette.greyPalette.tint200;
        _inlaidIndexPathSet = [NSMutableSet set];
        _cardBorderRadius = kCollectionViewCellDefaultBorderRadius;

        // Cell separator defaults.
        _separatorColor = GTCPalette.greyPalette.tint300;
        ...
        // Grid defaults.
        _cellLayoutType = GTCCollectionViewCellLayoutTypeList;
...
- (void)setCellStyle:(GTCCollectionViewCellStyle)cellStyle {
...
- (BOOL)shouldHideSeparatorForCellLayoutAttributes:(GTCCollectionViewLayoutAttributes *)attr {
...
(GTCCollectionViewLayoutAttributes *)attr {
    ...
    GTCCollectionViewCellStyle cellStyle = [self cellStyleAtSectionIndex:attr.indexPath.section];
    ...
    GTCCollectionViewOrdinalPosition position = attr.sectionOrdinalPosition;
    ...
    if ([self drawShadowForCellWithIsCardStye:isCardStyle
        ...
        switch (position) {
            case GTCCollectionViewOrdinalPositionVerticalTop:
                insets = UIEdgeInsetsMake(insets.top, insets.left, 0, insets.right);
                break;
            case GTCCollectionViewOrdinalPositionVerticalBottom:
                insets = UIEdgeInsetsMake(0, insets.left, insets.bottom, insets.right);
                break;
            case GTCCollectionViewOrdinalPositionVerticalCenter:
...
- (GTCCollectionViewCellStyle)cellStyleAtSectionIndex:(NSInteger)section {
    GTCCollectionViewCellStyle cellStyle = self.cellStyle;
    if (self.delegate &&
...
- (UIImage *)backgroundImageForCellLayoutAttributes:(GTCCollectionViewLayoutAttributes *)attr {
    BOOL isSectionHeader =
    [attr.representedElementKind isEqualToString:UICollectionElementKindSectionHeader];
    BOOL isSectionFooter =
    [attr.representedElementKind isEqualToString:UICollectionElementKindSectionFooter];
    ...
    BOOL isTop = attr.sectionOrdinalPosition & GTCCollectionViewOrdinalPositionVerticalTop;
    BOOL isBottom = attr.sectionOrdinalPosition & GTCCollectionViewOrdinalPositionVerticalBottom;

    GTCCollectionViewCellStyle cellStyle = [self cellStyleAtSectionIndex:attr.indexPath.section];
    BOOL isCardStyle = cellStyle == GTCCollectionViewCellStyleCard;
    BOOL isGroupedStyle = cellStyle == GTCCollectionViewCellStyleGrouped;
    BOOL isGridLayout = (_cellLayoutType == GTCCollectionViewCellLayoutTypeGrid);
    if (!isCardStyle && !isGroupedStyle) {
