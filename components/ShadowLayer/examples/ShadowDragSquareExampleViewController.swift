...
// This viewcontroller contains a subview that has an GTCShadowLayer.
...
class ShadowDragSquareExampleViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    // GTCShadowLayer's elevation will implicitly animate when changed, so to disable that behavior
