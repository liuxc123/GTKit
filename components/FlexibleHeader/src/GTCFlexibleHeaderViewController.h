//
//  GTCFlexibleHeaderViewController.h
//  GTCatalog
//
...
@class GTCFlexibleHeaderView;
@protocol GTCFlexibleHeaderViewLayoutDelegate;

/**
 The GTCFlexibleHeaderViewController controller is a simple UIViewController-oriented interface
 ...
 */
@interface GTCFlexibleHeaderViewController : UIViewController <UIScrollViewDelegate, UITableViewDelegate>

/** The flexible header view instance that this controller manages. */
@property(nonatomic, strong, nonnull, readonly) GTCFlexibleHeaderView *headerView;

/** The layout delegate will be notified of any changes to the flexible header view's frame. */
@property(nonatomic, weak, nullable) id<GTCFlexibleHeaderViewLayoutDelegate> layoutDelegate;
...
/**
 ...
 simple container view controller or by using GTCFlexibleHeaderContainerViewController. This
...
/**
 ...
 GTCFlexibleHeaderView.
 */
@protocol GTCFlexibleHeaderViewLayoutDelegate <NSObject>
@required

/**
 Informs the receiver that the flexible header view's frame has changed.

 The receiver should use the GTCFlexibleHeader scrollPhase APIs in order to react to the frame
 changes.
 */
- (void)flexibleHeaderViewController:
(nonnull GTCFlexibleHeaderViewController *)flexibleHeaderViewController
    flexibleHeaderViewFrameDidChange:(nonnull GTCFlexibleHeaderView *)flexibleHeaderView;

@end

@interface GTCFlexibleHeaderViewController (ToBeDeprecated)
