//
//  GTCFlexibleHeaderContainerViewController.m
//  GTCatalog
//
...
@interface GTCFlexibleHeaderContainerViewController ()

@end

@implementation GTCFlexibleHeaderContainerViewController


- (instancetype)initWithContentViewController:(UIViewController *)contentViewController {
    self = [super initWithNibName:nil bundle:nil];
    if (self) {
        _headerViewController = [[GTCFlexibleHeaderViewController alloc] init];
