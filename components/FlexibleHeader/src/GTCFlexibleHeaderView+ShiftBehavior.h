//
//  GTCFlexibleHeaderView+ShiftBehavior.h
//  GTCatalog
//
...
/**
 ...
 @c GTCFlexibleHeaderScrollPhaseShifting scroll phase.
 */
typedef NS_ENUM(NSInteger, GTCFlexibleHeaderShiftBehavior) {

    /** Header's y position never changes in reaction to scroll events. */
    GTCFlexibleHeaderShiftBehaviorDisabled,

    /** When fully-collapsed, the header translates vertically in reaction to scroll events. */
    GTCFlexibleHeaderShiftBehaviorEnabled,
...
typedef NS_ENUM(NSInteger, GTCFlexibleHeaderContentImportance) {
     ...
     */
    GTCFlexibleHeaderContentImportanceHigh,
};
...
/**
 ...
 GTCFlexibleHeaderShiftBehaviorDisabled. Attempts to set shiftBehavior to any other value if
 self.observesTrackingScrollViewScrollEvents is YES will result in an assertion being thrown.
 */
@property(nonatomic) GTCFlexibleHeaderShiftBehavior shiftBehavior;
...
/**
 ...
 Ignored if shiftBehavior == GTCFlexibleHeaderShiftBehaviorDisabled.

 Default: GTCFlexibleHeaderContentImportanceDefault
 */
@property(nonatomic) GTCFlexibleHeaderContentImportance headerContentImportance;
...
/**
 ...
 header shifting behavior is set to GTCFlexibleHeaderShiftBehaviorEnabled.
 */
