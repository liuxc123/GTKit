...
typedef void (^GTCFlexibleHeaderChangeContentInsetsBlock)(void);
typedef void (^GTCFlexibleHeaderShadowIntensityChangeBlock)(CALayer *_Nonnull shadowLayer,
                                                            CGFloat intensity);

/** Mutually exclusive phases that the flexible header view can be in. */
typedef NS_ENUM(NSInteger, GTCFlexibleHeaderScrollPhase) {
     ...
     */
    GTCFlexibleHeaderScrollPhaseShifting,
     ...
     */
    GTCFlexibleHeaderScrollPhaseCollapsing,
    ...
    /**
     ...
     frame.size.height is changing.
     */
    GTCFlexibleHeaderScrollPhaseOverExtending,
};

@protocol GTCFlexibleHeaderViewDelegate;

/**
 GTCFlexibleHeaderView tracks the content offset of a scroll view and adjusts its size and
 ...
 */
IB_DESIGNABLE
@interface GTCFlexibleHeaderView : UIView
...
intensityDidChangeBlock:(nonnull GTCFlexibleHeaderShadowIntensityChangeBlock)block;
 ...
 */
- (void)changeContentInsets:(nonnull GTCFlexibleHeaderChangeContentInsetsBlock)block;
 ...
 */
@property(nonatomic, readonly) GTCFlexibleHeaderScrollPhase scrollPhase;
...
/**
 ...
 GTCFlexibleHeaderShiftBehaviorDisabled, an assertion will be thrown. If you intend to use any
...
@property(nonatomic, weak, nullable) id<GTCFlexibleHeaderViewDelegate> delegate;

@end

/**
 The GTCFlexibleHeaderViewDelegate protocol allows a delegate to respond to changes in the header
 view's state.

 The delegate is typically the UIViewController that owns this flexible header view.
 */
@protocol GTCFlexibleHeaderViewDelegate <NSObject>
@required
...
(nonnull GTCFlexibleHeaderView *)headerView;
...
/**
 ...
 should use the GTCFlexibleHeaderView scrollPhase APIs to determine which phase the header's frame
 is in.
 */
- (void)flexibleHeaderViewFrameDidChange:(nonnull GTCFlexibleHeaderView *)headerView;
