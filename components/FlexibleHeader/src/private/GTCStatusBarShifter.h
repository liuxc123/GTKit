...
@protocol GTCStatusBarShifterDelegate;
 ...
 */
@interface GTCStatusBarShifter : NSObject
...
@property(nonatomic, weak) id<GTCStatusBarShifterDelegate> delegate;
...
/**
 ...
 The implementor of GTCStatusBarShifterDelegate should use this to inform UIKit of the expected
...
/**
 The GTCStatusBarShifterDelegate protocol allows a delegate to react to changes in the status bar
 shifter's state.
 */
@protocol GTCStatusBarShifterDelegate <NSObject>
@required

/** Informs the receiver that the preferred status bar visibility has changed. */
- (void)statusBarShifterNeedsStatusBarAppearanceUpdate:(GTCStatusBarShifter *)statusBarShifter;
 ...
 */
- (void)statusBarShifter:(GTCStatusBarShifter *)statusBarShifter
