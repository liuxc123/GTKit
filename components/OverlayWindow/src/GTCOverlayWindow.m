...
/**
 ...
 Used by GTCOverlayWindow, overlay views are added to the overlay window container when
 @c activateOverlay is called and removed from the overlay window when @c deactivateOverlay is
 called.
 */
@interface GTCOverlayWindowContainerView : UIView
@end

@interface GTCOverlayWindow ()

@property(nonatomic, strong) NSMutableArray *overlays;
@property(nonatomic, strong) GTCOverlayWindowContainerView *overlayView;

// Forward declaration so that GTCOverlayWindowContainerView can call this method.
- (void)noteOverlayRemoved:(UIView *)overlay;

@end

@implementation GTCOverlayWindowContainerView

- (void)willRemoveSubview:(UIView *)subview {
    [super willRemoveSubview:subview];

    GTCOverlayWindow *window = (GTCOverlayWindow *)self.window;
...
@implementation GTCOverlayWindow
...
- (void)commonInit {
    ...
    _overlayView = [[GTCOverlayWindowContainerView alloc] initWithFrame:self.bounds];
