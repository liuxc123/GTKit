...
#       src/
#         GTIcons_ic_arrow_back.bundle/
#             ic_arrow_back.png
#             ic_arrow_back@2x.png
#             ic_arrow_back@3x.png
#         GTIcons+ic_arrow_back.h
#         GTIcons+ic_arrow_back.m
#     components/private/Icons/icons/ic_menu/
#       src/
#         GTIcons_ic_menu.bundle/
#             ic_menu.png
#             ic_menu@2x.png
#             ic_menu@3x.png
#         GTIcons+ic_menu.h
...
for directory in $ICONS_COMPONENT_PATH/icons/*/; do
  ...
  assets_path="$directory/src/GTIcons_$icon_name.bundle"
  ...
  cat >> "$GENERATED_ICONS_SCRIPT_PATH" <<EOL
    ...
    iss.subspec "$icon_name" do |ss|
      ...
      ss.resource_bundles = {
        "GTIcons_$icon_name" => [
          "$ICONS_COMPONENT_RELATIVE_PATH/icons/$icon_name/src/GTIcons_$icon_name.bundle/*.png",
        ]
      }
...
@interface GTCIcons ($icon_name)

/*
 Returns the path for the $icon_name image contained in
 GTIcons_$icon_name.bundle.
 */
...
static NSString *const kBundleName = @"GTIcons_$icon_name";
...
__attribute__((visibility("default")))
    char GTCIconsExportToSuppressLibToolWarning_$icon_name = 0;

@implementation GTCIcons ($icon_name)
